...
def main():
    ...
    with open(r'/scratch/kohler.d/code_output/biosim/lac_operon_labels.pickle', 'rb') as handle:
    ...
    for epoch in range(n_epochs):
        ...
        if epoch % 10 == 0:
            ...
            with open(r'/scratch/kohler.d/code_output/biosim/cnn_losses_lo.pickle', 'wb') as handle:
                pickle.dump(losses, handle, protocol=pickle.HIGHEST_PROTOCOL)
            torch.save(state, r'/scratch/kohler.d/code_output/biosim/cnn_model_lo_temp.pth')
    ...
    torch.save(state, r'/scratch/kohler.d/code_output/biosim/cnn_model_lo.pth')
    print("saved")
